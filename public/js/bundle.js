...
var showAlert = function showAlert(type, msg) {
  ...
  alertEl.className = "alert alert--".concat(type);
...
var _default = API;
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js"}],"auth.js":[function(require,module,exports) {
"use strict";
...
},{"./alerts":"alerts.js","./axios":"axios.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZGVucmlvbjkxIiwiYSI6ImNrYmtzYmFxYzA4cjUyeHA5bjE3cHp0aGkifQ._LXRLi5u6T35ZHtG_ULRKw";
...
var STRIPE_PUBLIC_KEY = 'pk_test_51Gx7jtLEXheXGSvBny8KxsSWPwwoIs9Y0Qs3N7wliuL3pRNuMmUCU5l3qDKFSo7kvLOiWfGMFiXrVLvefQRzjMi700ppXFkonb';
...
},{"./alerts.js":"alerts.js","./axios":"axios.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "/api/v1/auth/".concat(endpoint);
            _context.prev = 2;
            _context.next = 5;
          ...
          case 5:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.default)('success', "".concat(type.toUpperCase(), " updated successfuly"));
            _context.next = 12;
            break;
...
var userDataFormSubmitBtn = document.querySelector('.form-user-data .btn');
var userPasswordFormSubmitBtn = document.querySelector('.form-user-password .btn');
var bookTourBtn = document.getElementById('book-tour'); // DELEGATION

if (mapSection) {
  var locations = JSON.parse(mapSection.dataset.locations);
...
if (userDataFormSubmitBtn) {
  userDataFormSubmitBtn.addEventListener('click', function (e) {
    e.preventDefault();
...
if (userPasswordFormSubmitBtn) {
  userPasswordFormSubmitBtn.addEventListener('click', /*#__PURE__*/function () {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "63694" + '/');

    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.default)('success', 'Data updated successfuly');
            _context.next = 12;
            break;
...
var userDataFormSubmitBtn = document.querySelector('.form-user-data .btn'); // DELEGATION
